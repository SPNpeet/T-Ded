...
## 1.5 ถ้าต้องการถูกที่สุด (เรียงจากถูกสุดจริง ๆ)

| ทาง | ค่าใช้จ่ายจริง/เดือน | ได้อะไร | ข้อควรรู้ |
|---|---|---|---|
| **GitHub Pages อย่างเดียว** | **0 บาท** | เครื่องคำนวณ จำลองรุ่น ตารางอาหาร ยี่ห้ออาหาร ใช้ออฟไลน์ ติดตั้งลงมือถือ | ไม่มีบัญชีผู้ใช้/ไม่เก็บบันทึกบนเซิร์ฟเวอร์ (ทำได้แล้ว ใช้ได้เลย) |
| **Oracle Cloud Always Free** | **0 บาท ตลอดชีพ** | ระบบเต็ม เครื่อง ARM 4 คอร์ 24GB RAM ที่สิงคโปร์ | ต้องยืนยันบัตรตอนสมัคร (ไม่ตัดเงิน) แรงกว่า VPS เสียเงินหลายเจ้า — **คุ้มที่สุดถ้าอยากได้ระบบเต็มถาวร** |
| **Fly.io free allowance** | 0 บาท ถ้าไม่เกินโควตา | ระบบเต็ม เครื่องเล็ก หลับ/ตื่นเอง | ต้องผูกบัตร มีโอกาสเกินโควตาถ้าคนใช้เยอะ |
| **รันที่บ้าน + ngrok ฟรี** | ค่าไฟ ~150-250 บาท | ระบบเต็ม ลิงก์คงที่ 1 โดเมนฟรี | ต้องเปิดคอมทิ้งไว้ 24 ชม. เน็ตบ้านล่ม = แอปล่ม |
| VPS ไทย ถูกสุด | 150-300 บาท | ระบบเต็ม เร็วสุดสำหรับคนไทย | เสียเงินจริงทุกเดือน |

**สรุปคำแนะนำเรื่องงบ:** ใช้ GitHub Pages (ฟรี) เป็นหน้าหลักสำหรับเครื่องคำนวณไปก่อน และถ้าจะเปิดระบบเต็มให้เกษตรกรหลายคนใช้จริง ให้ไป **Oracle Cloud Always Free** — ฟรีถาวรและแรงกว่าการเปิดคอมที่บ้านทิ้งไว้ (ซึ่งกินค่าไฟเดือนละ 150-250 บาท แพงกว่าฟรี)
